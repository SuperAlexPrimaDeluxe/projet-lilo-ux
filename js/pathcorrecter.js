...
document.getElementById("bancontact").src = "../medias/icons/BANCONTACT_LILO.svg";
document.getElementById("maestro").src = "../medias/icons/MAESTRO_LILO.svg";
document.getElementById("mastercard").src = "../medias/icons/MASTERCARD_LILO.svg";
document.getElementById("paypal").src = "../medias/icons/PAYPAL_LILO.svg";
document.getElementById("visa").src = "../medias/icons/VISA_LILO.svg";
document.getElementById("bpost").src = "../medias/icons/bpostlogo.svg";
document.getElementById("logofooterlilo").src = "../medias/icons/lilologo.svg";
document.getElementById("facebookfooter").src = "../medias/icons/facebook.svg";
document.getElementById("instafooter").src = "../medias/icons/instagram.svg";
document.getElementById("mailfooter").src = "../medias/icons/Mail.svg";
console.log("la bille noire");

/* Changement des liens pour le HEADER */

document.getElementById("returnhome").href = "../index.html";
document.getElementById("txtconnexion").href = "../login/connexion.html";
document.getElementById("godash0").href = "../login/dashboard.html";
